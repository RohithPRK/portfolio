          ...
          <div className="apple-glass shimmer-border rounded-3xl p-6 sm:p-8 space-y-6">
            ...
            <div className="space-y-3 pt-2 border-t border-white/10">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                >
                  <Mail className="w-4 h-4 mx-auto text-slate-300 group-hover:scale-110 transition-transform" />
                  <span className="text-[10px] font-mono text-slate-400 block truncate">Email</span>
                </a>
