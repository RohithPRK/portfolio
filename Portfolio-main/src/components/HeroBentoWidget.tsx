...
export const HeroBentoWidget: React.FC = () => {
  ...
  const techOrbit = [
    ...
    { name: 'Snowflake', role: 'Cloud Data Warehousing', color: 'from-blue-500 to-cyan-500', icon: Cloud },
    { name: 'RAG & Graph RAG', role: 'Semantic Document Search', color: 'from-cyan-500 to-blue-500', icon: Database },
    { name: 'Prefect & Airbyte', role: 'Data Pipelines & Prep', color: 'from-amber-500 to-orange-500', icon: Workflow },
    { name: 'Power BI', role: 'Enterprise Analytics', color: 'from-sky-500 to-indigo-500', icon: Layers },
  ];
