    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-24 sm:pt-28 pb-16 space-y-14">
      ...
      >
        ...
        <div className="space-y-4 text-sm sm:text-base text-slate-300 leading-relaxed font-sans">
          ...
          <p>
            Currently at <strong className="text-white">Data Aces</strong>, I work on conversational AI platforms with LangGraph, Advanced RAG techniques, and Agentic AI workflows.
          </p>
        </div>
      </motion.div>
      ...
      >
        <div className="space-y-1 text-center sm:text-left">
          ...
          <p className="text-xs text-slate-400">
            Open for discussions on software engineering, AI systems, Agentic Workflows.
          </p>
        </div>
