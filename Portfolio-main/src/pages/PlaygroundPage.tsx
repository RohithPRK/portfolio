    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-24 sm:pt-28 pb-16 space-y-16">
      ...
      <div className="space-y-4 max-w-3xl">
        ...
        <p className="text-sm sm:text-base text-slate-300 leading-relaxed font-sans">
          Experience how Rohith's production pipelines execute step-by-step: from vector ingestion and hybrid retrieval to LangGraph agent routing, MCP tool dispatch, and DeepEval evaluation.
        </p>
